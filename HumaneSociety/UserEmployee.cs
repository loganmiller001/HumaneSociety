...
namespace HumaneSociety
{
    class UserEmployee : User 
    {
        ...
        private void CheckShots(Animal animal)
        {
            ...
            foreach (AnimalShot animalShot in shots.ToList())
            {
                // use shot.ShotId to get Shot
        ...
        private void UpdateAnimal(Animal animal)
        {
            ...
            List<string> options = new List<string>() { "Select Updates: (Enter number and choose finished when finished)", "1. Name", "2. Species", "3. Age", "4. Demeanor", "5. Kid friendly", "6. Pet friendly", "7. Weight", "8. Finished" };
            UserInterface.DisplayUserOptions(options);
            string input = UserInterface.GetUserInput();
